...
WebUI.uploadFile(findTestObject('konfirmasi pesanan/input_Upload Bukti Transfer_f'), 'F:\\bootcamp\\Miniproject\\Transfer.pdf')
...
assert totalBayar == ttlBayar

assert naamaPengirim == nmPengirim
