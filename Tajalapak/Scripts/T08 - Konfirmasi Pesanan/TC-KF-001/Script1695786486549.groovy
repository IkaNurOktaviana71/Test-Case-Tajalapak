...
WebUI.selectOptionByValue(findTestObject('Object Repository/konfirmasi pesanan/select dropdown trasfer'), transfer, false)
...
WebUI.setText(findTestObject('konfirmasi pesanan/input_Tanggal Transfer_e'), tanggal)

WebUI.click(findTestObject('konfirmasi pesanan/button_Konfirmasi Pembayaran'))

WebDriver webDriver = DriverFactory.getWebDriver()

//mengambil objek upload
field_photo = webDriver.findElement(By.xpath('//input[@name="f"]'))

error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_photo)
