...
WebUI.callTestCase(findTestCase('T08 - Konfirmasi Pesanan/TC-OS-001'), [('Roda') : '2', ('MetodePembayaran') : 'transfer'], 
...
field_count = webDriver.findElement(By.xpath('(//input[@name="b"])[3]'))

error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_count)
