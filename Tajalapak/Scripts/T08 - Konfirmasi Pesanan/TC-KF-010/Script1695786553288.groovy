...
WebUI.setText(findTestObject('konfirmasi pesanan/input_Total TagihanTransfer_b'), tagihan)
...
WebUI.setText(findTestObject('konfirmasi pesanan/input_Nama Pengirim_d'), nmPengirim)
