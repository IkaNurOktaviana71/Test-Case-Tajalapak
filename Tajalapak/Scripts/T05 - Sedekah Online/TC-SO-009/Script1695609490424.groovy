...
field_doa = webDriver.findElement(By.xpath('//textarea[@name="doa_terbaik"]'))

validationMessage = WebUI.executeJavaScript("return arguments[0].validationMessage", Arrays.asList(field_doa))

assert validationMessage == "Maximum length of this field must be equal or greater than 150 symbols"
