...
field_sedekah = webDriver.findElement(By.xpath('//input[@name="nominal"]'));

//mengambil error message
error_message = ((JavascriptExecutor) webDriver)
	.executeScript("return arguments[0].validationMessage", field_sedekah);
println error_message

//verifikasi apakah error message sesuai
assert error_message == "please input an valid number";
