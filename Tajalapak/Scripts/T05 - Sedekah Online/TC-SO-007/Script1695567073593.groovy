...
//mengmabil objek inputan email terlebih dahulu
field_nomor = webDriver.findElement(By.xpath('//input[@name="validasi"]'))

//mengambil error message
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_nomor)

println(error_message)

//verivikasi apakah error message sesuai
assert error_message == 'Please select a valid value. The two nearest valid values are 0 and 1.'
