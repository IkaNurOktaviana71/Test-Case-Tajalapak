...
//memverifikasi sudah sukses bersedekah online (BELUM)
WebUI.verifyElementText(findTestObject('sedekah online/verifikasi gagal bernoasi beda dua digit nomor hp'), 'GAGAL Diproses, 2 Digit Terakhir No Handphone yang anda input salah!')
