...
field_insta = webDriver.findElement(By.xpath('(.//*[normalize-space(text()) and normalize-space(.)="Instagram"])[1]/following::div[1]'))

validationMessage = WebUI.executeJavaScript('return arguments[0].validationMessage;', Arrays.asList(field_insta))

assert validationMessage == 'please input username not exceed 50 character'
