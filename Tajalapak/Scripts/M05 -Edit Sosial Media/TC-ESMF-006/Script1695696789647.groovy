...
field_google = webDriver.findElement(By.xpath('(.//*[normalize-space(text()) and normalize-space(.)="Google+"])[1]/following::div[1]'))

error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_google)

println(error_message)

assert error_message == 'Please include an \'+\' at the first place username'
