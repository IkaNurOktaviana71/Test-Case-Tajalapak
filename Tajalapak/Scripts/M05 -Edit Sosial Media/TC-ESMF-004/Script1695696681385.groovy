...
field_telegram = webDriver.findElement(By.xpath('(.//*[normalize-space(text()) and normalize-space(.)="Telegram"])[1]/following::div[1]'))

error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_telegram)

println(error_message)

assert error_message == 'please include an \'@\' in the first place username'
