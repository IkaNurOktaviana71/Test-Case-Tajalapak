...
WebUI.setEncryptedText(findTestObject('Pendaftaran/input password'), 'NqvfBr/61hkKg4Ngn0KWJw==')

WebUI.setEncryptedText(findTestObject('Pendaftaran/input konfirmasi password'), 'NqvfBr/61hkKg4Ngn0KWJw==')

WebUI.click(findTestObject('Pendaftaran/button_Daftar'))

WebUI.verifyTextPresent('password must include alpanumeric', false)
