...
WebUI.setText(findTestObject('Pendaftaran/input username'), 'anata 71')

//get text alert on the alert when its show
alertText = WebUI.getAlertText();

//memverifikasi apakah textnya sama dengan yang di tampilkan

WebUI.verifyMatch(alertText, 'Maaf, Tidak Boleh Menggunakan Spasi,..', false)
