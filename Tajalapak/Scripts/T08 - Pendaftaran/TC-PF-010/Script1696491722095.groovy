...
WebUI.setEncryptedText(findTestObject('Pendaftaran/input password'), '3t/5BPxJM2g=')

WebUI.setEncryptedText(findTestObject('Pendaftaran/input konfirmasi password'), '3t/5BPxJM2g=')

WebUI.click(findTestObject('Pendaftaran/button_Daftar'))

WebUI.verifyTextPresent('Minimum length of this field must be equal or greater than 7 characters', false)
