...
//mengambil objek inputan konfirmasi password terlebih dahulu
field_konfrim_password = webDriver.findElement(By.xpath('//input[@name="repassword"]'))

//mengambil error message
error_message = ((JavascriptExecutor) webDriver)
	.executeScript("return arguments[0].validationMessage", field_konfrim_password)
