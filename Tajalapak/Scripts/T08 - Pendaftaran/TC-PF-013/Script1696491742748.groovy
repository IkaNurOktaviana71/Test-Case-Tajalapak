...
//mengambil inputan dari nomor handphone
field_no = webDriver.findElement(By.xpath('(//input[@name="b"])[4]'))

error_message = ((JavascriptExecutor) webDriver).executeScript("return arguments[0].validationMessage", field_no)
println error_message

//verifikasi apakah error sesuai 
