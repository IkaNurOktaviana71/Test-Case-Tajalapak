...
WebUI.setText(findTestObject('Login/input_Username, Email atau No. Handphone_a'), 'anata61')

WebUI.setEncryptedText(findTestObject('Login/input_Password di Login(Masuk)'), 'qbkrdMwyWE4=')

WebUI.click(findTestObject('Login/button_Masuk di halaman login'))
