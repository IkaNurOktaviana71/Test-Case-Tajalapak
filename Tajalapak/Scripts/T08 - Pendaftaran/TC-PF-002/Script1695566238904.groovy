...
WebUI.setEncryptedText(findTestObject('Pendaftaran/input konfirmasi password'), 'cEZ5BwTAfeQ=')

WebUI.click(findTestObject('Pendaftaran/button_Daftar'))

WebUI.verifyElementText(findTestObject('Pendaftaran/verifikasi error untuk password dan konfirmasi password berbeda'), 'Password anda tidak Valid!')
