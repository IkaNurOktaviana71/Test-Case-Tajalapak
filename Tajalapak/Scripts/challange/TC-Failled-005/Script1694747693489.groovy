...
WebUI.setText(findTestObject('modul berita/input isi berita'), 'wah sepak bola di  indonesi semangkin meningkat 5 \twah! sepak bola indonesi semangkin meningkat 5 \twah! sepak bola indonesi semangkin meningkat 5 \twah! sepak bola indonesi semangkin meningkat5 \twah! sepak bola indonesi semangkin meningkat')
...
field_kategori = webDriver.findElement(By.xpath('//select[@name="a"]'))

error_message =((JavascriptExecutor) webDriver).executeScript("return arguments[0].validationMessage", field_kategori)
